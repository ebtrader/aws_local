...
with SSHTunnelForwarder(
    ...
    try:
        ...
        with db.cursor() as cur:
            ...
            cur.execute('''CREATE TABLE javeddb.insects (`PersonID` int DEFAULT NULL,`LastName` varchar(255) DEFAULT NULL,
            `FirstName` varchar(255) DEFAULT NULL,`Address` varchar(255) DEFAULT NULL,`City` varchar(255) DEFAULT NULL) 
